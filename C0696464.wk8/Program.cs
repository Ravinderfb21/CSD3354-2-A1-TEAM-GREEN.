...
namespace C0703625
{
    class CountrySide
    {
        ...
        public void TraverseVillages(Village CurrentVillage)
        {
            ...
            try
            {
                ...
                if (CurrentVillage.isAstrildgeHere)
                {
                    ...
                    Console.WriteLine("Astrilde, I walked {0} kilometeres to find you. Will you marry me?", Hugi.CalculateDistanceWalked());
        ...
        public void Announcement()
        {
            try
            {
                using (StreamReader sr = new StreamReader("inderj.txt"))
                {
                    string line;
